    ...
    if (query === "Robot Account") {
        ...
        rl.question(chalk.magenta(">") + ' Enter the bot\'s token: ', (token) => {
            robo.once("ready", async () => {
                ...
                console.log(`${chalk.magenta(">")} Members: ${findGuild.members.cache.size} \n${chalk.magenta(">")} Channels: ${findGuild.channels.cache.size} \n${chalk.magenta(">")} Roles: ${findGuild.roles.cache.size}`)
